export default function AboutPage() {
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-10">
      <h1 className="mb-2 text-2xl font-semibold text-gray-900 dark:text-white">About HealthAssist UG</h1>
      ...
      <div className="space-y-6 text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
        <section>
          <h2 className="mb-1 font-semibold text-gray-900 dark:text-white">⚕ Important Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-semibold text-gray-900 dark:text-white">What this tool can help with</h2>
        ...
        <section>
          <h2 className="mb-1 font-semibold text-gray-900 dark:text-white">Data sources</h2>
          <ul className="ml-4 list-disc space-y-1">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-gray-900 dark:text-white">Emergency contacts</h2>
          <ul className="ml-4 list-disc space-y-1">
